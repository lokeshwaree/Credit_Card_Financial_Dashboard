...
COPY cc_detail
FROM 'C:\Program Files\PostgreSQL\16\data\Credit Card Financial Dashboard-20240512T111825Z-001\Credit Card Financial Dashboard\credit_card.csv'
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'C:\Program Files\PostgreSQL\16\data\Credit Card Financial Dashboard-20240512T111825Z-001\Credit Card Financial Dashboard\customer.csv'
DELIMITER ',' 
CSV HEADER;
...
COPY cc_detail
FROM 'C:\Program Files\PostgreSQL\16\data\Credit Card Financial Dashboard-20240512T111825Z-001\Credit Card Financial Dashboard\cc_add.csv'
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'C:\Program Files\PostgreSQL\16\data\Credit Card Financial Dashboard-20240512T111825Z-001\Credit Card Financial Dashboard\cust_add.csv'
DELIMITER ',' 
CSV HEADER;
